...
#ifndef INC__JACURSES_BYTEBUFFER_H
#define INC__JACURSES_BYTEBUFFER_H
...
static void bytebuffer_clear( struct bytebuffer* b ) { b->len = 0; }

static void bytebuffer_append(
	struct bytebuffer* b, const char* data, int len )
{
...
#endif /* INC__JACURSES_BYTEBUFFER_H */
