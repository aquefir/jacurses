...
#ifndef INC_API__TERMBOX_H
#define INC_API__TERMBOX_H
...
#define TB_KEY_INSERT 0xFFF3
#define TB_KEY_DELETE 0xFFF2
#define TB_KEY_HOME 0xFFF1
#define TB_KEY_END 0xFFF0
#define TB_KEY_PGUP 0xFFEF
#define TB_KEY_PGDN 0xFFEE
...
#define TB_KEY_MOUSE_MIDDLE 0xFFE7
#define TB_KEY_MOUSE_RELEASE 0xFFE6
...
{
	u8 type;
	u8 mod; /* modifiers to either 'key' or 'ch' below */
	u16 key; /* one of the TB_KEY_* constants */
	u32 ch; /* unicode character */
	s32 w, h, x, y;
};
...
SO_IMPORT void tb_set_clear_attributes( u16 fg, u16 bg );
...
SO_IMPORT void tb_change_cell(
	int x, int y, u32 ch, u16 fg, u16 bg );
 ...
 */
SO_IMPORT void tb_blit(
	int x, int y, int w, int h, const struct tb_cell* cells );
...
SO_IMPORT int tb_utf8_char_to_unicode( u32* out, const char* c );
SO_IMPORT int tb_utf8_unicode_to_char( char* out, u32 c );

#endif /* INC_API__TERMBOX_H */
